...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$user) {
        HTTP::redirect('/src/Admin/design/profile.php', "error=user_not_found");
        exit();
    }
    ...
    if (!password_verify($current_password, $user->password)) {
        ...
        HTTP::redirect('/src/Admin/design/profile.php');
        exit();
    }
    ...
    if ($result) {
        ...
        HTTP::redirect('/src/Admin/design/profile.php', "error=update_failed");
        exit();
    }
} else {
