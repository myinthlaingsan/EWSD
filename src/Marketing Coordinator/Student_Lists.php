                    ...
                    <div class="col">
                        <div class="card p-4">
                            ...
                            <div class="mt-5 text-center">
                                <a href="Student_Details.php?id=<?php echo $index; ?>" class="btn btn-primary px-4 py-2 rounded-pill shadow-sm d-flex align-items-center justify-content-center mx-auto">
